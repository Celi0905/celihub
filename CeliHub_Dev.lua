...
local COPYER_URL    = "https://raw.githubusercontent.com/Celi0905/celihub/main/CeliHub_GameCopyer.lua"
local DONATE_URL     = "https://raw.githubusercontent.com/Celi0905/celihub/main/CeliHub_PlsDonate.lua"
...
local function ShowDevGameSelector()
    ...
    local GAMES = {
        ...
        {icon="📋", title="Celi Game Copyer",  desc="Game kopieren & speichern\nSynSaveInstance • .rbxl",       col=Color3.fromRGB(50,160,220),  glow=Color3.fromRGB(80,200,255),  key="copyer"},
        {icon="💰", title="PLS DONATE Tool",  desc="Fake Donate • Stand • ESP\nAuto-Collect • Leaderboard",  col=Color3.fromRGB(255,185,0),  glow=Color3.fromRGB(255,220,80),  key="donate"},
    ...
    Foot.Text="CeliHub Dev  •  by Celi 💫  •  8 Optionen  •  Kein Key benötigt"; Foot.TextColor3=Color3.fromRGB(0,100,45); Foot.Font=Enum.Font.Gotham; Foot.TextSize=11; Foot.ZIndex=3
...
if choice ~= "devself" then
    local URLS = {
        ...
        universal=UNIVERSAL_URL, coolgui=COOLGUI_URL, music=MUSIC_URL, copyer=COPYER_URL, donate=DONATE_URL,
    }
