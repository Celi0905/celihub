...
local function ShowDevGameSelector()
    ...
    Foot.Text="CeliHub Dev  •  by Celi 💫  •  7 Optionen  •  Kein Key benötigt"; Foot.TextColor3=Color3.fromRGB(0,100,45); Foot.Font=Enum.Font.Gotham; Foot.TextSize=11; Foot.ZIndex=3
...
if choice ~= "devself" then
    local URLS = {
        ...
        universal=UNIVERSAL_URL, coolgui=COOLGUI_URL, music=MUSIC_URL, copyer=COPYER_URL,
    }
